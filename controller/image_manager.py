...
def detail(album_id):
    ...
    return render_template(TEMPLATE_ROUTE + 'detail.html', images=images, album_id=album_id)
...
def upload_image(album_id):
    if request.method == "POST":
        ...
        up_image(filename, id, image_name, album_id, file_size)  # upload image to server
